                          ...
                          <div class="p-4 w-100 flex-grow-1 d-flex align-items-center">
                              <div class="w-100">
                                  ...
                                  <div class="text-center mb-2">
                                      ...
                                      <!--    Welcome, please login into student account.-->
                                      <!--</h2>-->
                                  </div>
                                  <!-- END Header -->
                                  ...
                                  <div class="row no-gutters justify-content-center">
                                      <div class="col-sm-8 col-xl-6">
                                          ...
                                          <div class="form-group">
                                              <input type="text"
                                                  class="form-control form-control-lg form-control-alt py-4" id="reg_no"
                                                  name="reg_no" placeholder="Enter your UUCMS/BCU Register Number">
                                          </div>
                                          <div class="form-group">
                                              <input type="password"
